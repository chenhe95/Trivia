...
public class Actors {
	...
	static final String BUILD_PATH = "/Users/fanglinlu/Desktop/actors.csv";
	...
	public static void main(String[] args) throws SQLException,ClassNotFoundException, IOException, ParseException {
		...
		stmt.executeUpdate("TRUNCATE actors");
		...
		while ((line = br.readLine()) != null) {
			...
			sql.append("INSERT INTO actors VALUES (");
			
			sql.append(str[0] + "," + "'" + str[1].trim().replace("\"", "").replace("'", "\\'") + "', '" + str[2].trim() + "', '"+ str[3].trim() + "')");
