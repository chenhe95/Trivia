...
public class MovieGenre {
	...
	static final String BUILD_PATH = "/Users/fanglinlu/Desktop/movie_genre.csv";
	...
	public static void main(String[] args) throws SQLException,ClassNotFoundException, IOException, ParseException {
		...
		stmt.executeUpdate("TRUNCATE movie_genre");
		stmt.executeUpdate("SET FOREIGN_KEY_CHECKS = 1");
		while ((line = br.readLine()) != null) {
			sql = new StringBuilder();
			
			sql.append("INSERT INTO movie_genre VALUES (");
			String[] str = line.split(",");
			
			sql.append("'" + str[0].trim().replace("\"", "").replace("'", "\\'") + "'" + "," + "'" + str[1] + "')");
